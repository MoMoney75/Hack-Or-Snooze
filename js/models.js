...
class Story {
  ...
  getHostName() {
    //GETS HOST NAME OF THE URL USING URL CONSTRUCTOR IN STORY CLASS
...
class StoryList {
  ...
  /** Adds story data to API, makes a Story instance, adds it to story list. STORYLIST VARIABLE??
  ...
  //USE POST REQUEST!
  //BASE_URL/STORIES
  //TAKES currentUser FROM users.js AS FIRST PARAMETER.
...
class User {
  ...
  //FUNCTION FOR ADDING  A STORIES TO FAVORITES ARRAY
